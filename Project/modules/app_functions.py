...
class AppFunctions(MainWindow):
    def setThemeHack(self,target=1):
        ...
        if target==1:
            ...
            for i in range(2, 200):  # 从2到12（包含12）
            ...
            self.ui.pushButton_9.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_38.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_9.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_39.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_40.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_41.setStyleSheet("background-color: rgb(33, 37, 43);")
            self.ui.pushButton_42.setStyleSheet("background-color: rgb(33, 37, 43);")
